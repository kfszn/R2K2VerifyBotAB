...
await pool.query(`CREATE TABLE IF NOT EXISTS user_links ( discord_id VARCHAR(255) PRIMARY KEY, acebet_username VARCHAR(255) NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP )`);
